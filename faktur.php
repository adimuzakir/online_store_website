...
<html>
<head>
	<title> Burai SHOP | Faktur </title>
	<link rel="stylesheet" href="admin/assets/bower_components/bootstrap/dist/css/bootstrap.min.css">
</head>
<body background="faktur.jpg">
<?php include 'menu.php'; ?>
	<section class="konten">
		<div class="container">
			<h2><font face ="algerian">Detail Pembelian</font></h2>
				<?php 
				...
				<div class="row">
					<div class="col-md-7">
						<div class="alert alert-info">
							<p>Silahkan melakukan pembayaran sebesar <strong>Rp. <?php echo number_format($detail['Total_Bayar']); ?></strong>
								Ke
							</p>
							<p>
								<strong><?php echo $detaill['Nm_Bayar']; ?> : 
								<?php echo $detaill['No_Akun']; ?> a.n. <?php echo $detaill['Nm_Akun']; ?></strong>
							</p>
						</div>	
					</div>
				</div>
				<a href="riwayat.php" class="btn btn-primary">Bayar</a>
		</div>	
</body>
</html>