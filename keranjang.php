...
<head>
	<meta charset="UTF-8">
	<title>Burai SHOP | Keranjang</title>
	<link rel="stylesheet" href="admin/assets/bower_components/bootstrap/dist/css/bootstrap.min.css">
</head>
<body>
<BODY STYLE="BACKGROUND-IMAGE:URL(keranjang.JPEG)">
	<?php include 'menu.php'; ?>
	
	<section class="konten">
		<div class="container">
			<marquee><h1><b><font face ="cornsilk"color="white">Keranjang Belanja </font></b></h1></marquee>
