...
?>
<h2>Data Jenis</h2>
		<form class="form-horizontal" role="search" method="post" action="index2.php?halaman=caridaftarkirim2">
		<div class="col-md-3">
...
<table class="table table-bordered"background="bg.jpg">
	...
	<tbody>
		...
		<?php while($pecah=$ambil->fetch_assoc()){?>
			<tr>
				...
				<td>
					<a href="index2.php?halaman=hapusdaftarkirim2&id=<?php echo $pecah['Id_DaftarKirim'];?>" class="btn-danger btn">Hapus</a>
					<a href="index2.php?halaman=ubahdaftarkirim2&id=<?php echo $pecah['Id_DaftarKirim'];?>" class="btn btn-warning">Ubah</a>
				</td>	
			</tr>
			<?php $nomor++ ?>
			<?php } ?>
	...
	<a href="index2.php?halaman=tambahdaftarkirim2" class ="btn btn-primary">Tambah Daftar Kirim</a>