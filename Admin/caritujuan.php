...
?>
<h3>Data Warna</h3>
		<form class="form-horizontal" role="search" method="post" action="index.php?halaman=caritujuan">
		<div class="col-md-3">
	...
	<tbody>
		...
		<tr>
			...
			<td> 
				...
				<a href="index.php?halaman=ubahtujuan&id=<?php echo $pecah['Id_Tujuan'];?>" class="btn btn-warning"> Ubah </a>
			</td>
		</tr>
		<?php $nomor++; ?>
		<?php } ?>
...
<a href=" index.php?halaman=tambahtujuan" class ="btn btn-primary"> Tambah Tujuan</a>